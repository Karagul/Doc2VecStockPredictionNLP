...
def train_doc2vec(model, tagged_data, max_epochs=100, update_vocab=False,
                  print_detail=False, save_sampling=10):
...
if __name__ == '__main__':
    ...
    doc2vec_model = train_doc2vec(
        doc2vec_model, tagged_doc, max_epochs, False, True
    )
